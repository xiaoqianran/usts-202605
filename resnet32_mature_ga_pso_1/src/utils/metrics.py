...
@torch.no_grad()
def measure_flops(model: nn.Module, input_size: Tuple[int, int, int] = (3, 32, 32), device: str | torch.device = "cpu") -> int:
    """Approximate multiply-add FLOPs for one image.

    Counts Conv2d and Linear only. This is sufficient for consistent coursework
    comparison of ResNet32 channel configurations.
    """
