...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare baseline ResNet32 and compressed stage/block-width ResNet32 summaries")
    ...
    result = {
        ...
        "baseline_stage_channels": base.get("stage_channels"),
        "compressed_stage_channels": comp.get("stage_channels"),
        ...
        "compressed_kd_mode": comp.get("kd_mode", "none"),
        "teacher_ckpt": comp.get("teacher_ckpt"),
        "kd_alpha": comp.get("kd_alpha"),
        "kd_temperature": comp.get("kd_temperature"),
        "at_weight": comp.get("at_weight"),
    }
