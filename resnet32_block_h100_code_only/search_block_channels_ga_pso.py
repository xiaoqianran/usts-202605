...
Candidate = Tuple[int, ...]
# 15-D block-level search space: 5 blocks per stage.
# Conservative defaults avoid tiny models that look good only because of resource penalty.
DEFAULT_STAGE_SPACE = [[12, 16], [20, 24, 28, 32], [40, 48, 56, 64]]
